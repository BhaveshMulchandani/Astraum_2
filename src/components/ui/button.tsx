  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-accent text-accent-foreground hover:bg-charcoal-light shadow-medium hover:shadow-large tracking-wider uppercase",
        gold: "bg-primary text-primary-foreground hover:bg-gold-dark shadow-gold hover:shadow-large tracking-wide",
        "outline-light": "border-2 border-accent-foreground bg-transparent text-accent-foreground hover:bg-accent-foreground hover:text-accent",
      ...
      size: {
        ...
        xl: "h-16 px-12 rounded-md text-lg",
